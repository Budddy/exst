...
namespace exst {
    ...
    public:
        ...
        void testParseParameter() {
            int i = 0;
            CPPUNIT_ASSERT_MESSAGE("", ExstFlags::parseParameter(nullptr, std::string("printDgraph"),
                                                                        std::string("0,./dGraph")));
            ...
            CPPUNIT_ASSERT_MESSAGE("", ExstFlags::parseParameter(nullptr, std::string("printIgraph"),
                                                                        std::string("1,./iGraph")));
            ...
            CPPUNIT_ASSERT_MESSAGE("", ExstFlags::parseParameter(nullptr, std::string("printRgraph"),
                                                                        std::string("2,./rGraph")));
        ...
        void testParseParameterEmptyName() {
            CPPUNIT_ASSERT_MESSAGE("", not ExstFlags::parseParameter(nullptr, std::string(""),
                                                                            std::string("0,./dGraph")));
        }

        void testParseParameterEmptyValue() {
            CPPUNIT_ASSERT_MESSAGE("", not ExstFlags::parseParameter(nullptr, std::string("printDgraph"),
                                                                            std::string("")));
        }

        void testParseParameterWrongName() {
            CPPUNIT_ASSERT_MESSAGE("", not ExstFlags::parseParameter(nullptr, std::string("wrong"),
                                                                            std::string("0,./dGraph")));
        }
