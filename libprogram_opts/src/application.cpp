...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    Application::Application() : exitCode_(EXIT_FAILURE), timeout_(0), verbose_(0), fastExit_(false), blocked_(0),
                                 pending_(0) { }
...
// Process command-line options.
    bool Application::getOptions(int argc, char **argv) {
        ...
        try {
            ...
            Value *hv =
                    helpO.second == 1 ? storeTo(help)->flag() : storeTo(help, &HelpParser::parse)->arg("<n>")->implicit(
                            "1");
            basic.addOptions()
