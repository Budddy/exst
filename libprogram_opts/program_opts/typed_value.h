...
///////////////////////////////////////////////////////////////////////////////
    ...
    struct ValueMapping : ValueMappingBase {
        ...
        this_type &operator()(const char *strVal, T eVal) {
            base_type::add(strVal, static_cast<int>(eVal));
            return *this;
        }
        static ValueMapping &instance() {
            static ValueMapping m;
            return m;
        }
        ...
        static bool parse(const std::string &value, U &out) {
            ...
            if (const int *x = m.get(value.c_str())) {
                out = static_cast<U>(*x);
                return true;
            }
            return false;
    ...
    template<class T>
    ValueMapping<T> &values() { return ValueMapping<T>::instance(); }
...
///////////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        StoredValue(T &var, parser_type p)
                : Value(0), address_(&var), parser_(p) {
...
#define LIT_TO_STRING(lit) LIT_TO_STRING_X(lit)
    ...
    struct FlagAction {
        ...
        enum Action {
            act_store_true, act_store_false
        } act;
 ...
 */
    ...
    inline NotifiedValue<T> *notify(ParamT *p0, typename detail::Notify<const T *, ParamT>::type nf,
    ...
    template<class T, class ParamT>
    inline NotifiedValue<T> *storeNotify(T &obj, ParamT *p0, typename detail::Notify<const T *, ParamT>::type nf,
                                         typename detail::Parser<T>::type parser = &string_cast<T>) {
        return notify<T>(p0, nf, parser)->storeTo(obj);
    }
    template<class ParamT>
    inline NotifiedValue<bool> *flag(ParamT *p0, typename detail::Notify<const bool *, ParamT>::type nf,
