 ...
 */
    ...
    public:
        ...
        enum DescType {
            desc_name = 1, desc_default = 2, desc_implicit = 4
        };
        virtual ~Value();
        ...
        Value *negatable() {
            setProperty(property_negatable);
            return this;
        }
         ...
         */
        Value *composing() {
            setProperty(property_composing);
            return this;
        }
    ...
    protected:
        ...
        bool state(bool b, State s) {
            if (b) { state_ = static_cast<byte_t>(s); }
            return b;
        }
    ...
    private:
        enum {
            desc_pack = 8, level_shift = not_a_property, levels = 255 / level_shift
        };
