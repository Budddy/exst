    ...
    public:
        ...
        enum CreateFlag {
            ...
            // WATCH MODE - only for problem clauses
                    clause_watch_first = 1024,
            /**< Watch first free literals.                      */
                    clause_watch_rand = 2048,
            /**< Watch rand literals.                            */
        ...
        //@}
    private:
        static ClauseRep prepare(Solver &s, const Literal *in, uint32 inSize, const ClauseInfo &e, uint32 flags,
                                 Literal *out, uint32 outMax = UINT32_MAX);
...
//! Class for representing a clause in a solver.
    ...
    public:
         ...
         */
        static ClauseHead *newShared(Solver &s, SharedLiterals *lits, const ClauseInfo &e, const Literal head[3],
                                     bool addRef = true);
 ...
 */
    ...
    public:
        ...
        * \see ClauseCreator::prepare()
        */
        static LoopFormula *newLoopFormula(Solver &s, const ClauseRep &c1, const Literal *atoms, uint32 nAtoms,
 ...
 */
        ...
        public:
             ...
             */
            static ClauseHead *newClause(Solver &s, SharedLiterals *shared_lits, const ClauseInfo &e,
                                         const Literal *lits, bool addRef = true);
