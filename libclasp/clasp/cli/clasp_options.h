 ...
 */
        ...
        public:
            ...
            static const KeyType INVALID_KEY = (KeyType) -1;
            /**< Invalid key used to signal errors. */
            static const KeyType KEY_ROOT;
            /**< Root key of a configuration, i.e. "." */
            static const KeyType KEY_TESTER;
            /**< Root key for tester options, i.e. "tester." */
             ...
             */
            int getKeyInfo(KeyType key, int *nSubkeys = 0, int *arrLen = 0, const char **help = 0,
                           int *nValues = 0) const;
        ...
        private:
            ...
            int applyActive(int o, const char *setValue, std::string *getValue, const char **getDesc,
                            const char **name);
            // App interface impl
