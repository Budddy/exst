 ...
 */
    ...
    public:
        ...
        public:
            explicit NonHcfComponent(const SharedDependencyGraph &dep, SharedContext &generator, uint32 scc,
       ...
       */
        struct AtomNode : public Node {
            enum Property {
                property_in_choice = 1u, property_in_disj = 2u, property_in_ext = 4u, property_in_non_hcf = 8u
            };
            AtomNode() { }
       ...
       * The predecessors of a BodyNode are the body's subgoals.
        ...
        struct BodyNode : public Node {
            enum Type {
                type_normal = 0u, type_count = 1u, type_sum = 3u
            };
            enum Flag {
                flag_has_delta = 4u, flag_seen = 8u
            };
