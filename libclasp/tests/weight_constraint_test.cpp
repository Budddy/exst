    ...
    namespace Test {
        ...
        public:
            ...
            void testOnlyBTB() {
                ...
                WeightConstraint::CPair res = WeightConstraint::create(s, body, lits, 2,
                                                                       WeightConstraint::create_only_btb);
            ...
            void testOnlyBFB() {
                ...
                lits.push_back(WeightLiteral(d, 1));
                WeightConstraint::CPair res = WeightConstraint::create(s, body, lits, 2,
                                                                       WeightConstraint::create_only_bfb);
                CPPUNIT_ASSERT(res.first());
                s.assume(a) && s.propagate();
                uint32 dl = s.decisionLevel();
                s.assume(b) && s.propagate();
            ...
            void testAddOnLevel() {
                ...
                s.pushRoot(f);
                WeightConstraint::CPair res = WeightConstraint::create(s, body, lits, 2,
                                                                       WeightConstraint::create_no_add);
            ...
            void testCreateSatOnRoot() {
                ...
                WeightConstraint::CPair res = WeightConstraint::create(s, body, rep, WeightConstraint::create_no_add |
                                                                                     WeightConstraint::create_sat);
