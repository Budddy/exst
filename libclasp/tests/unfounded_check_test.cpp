        ...
        public:
            ...
            void testWithSimpleWeightConstraint() {
                builder.start(ctx)
                        ...
                        .startRule(WEIGHTRULE, 2).addHead(1).addToBody(1, true, 2).addToBody(2, true, 2).addToBody(3,
                                                                                                                   true,
                                                                                                                   1).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
                attachUfs();
            ...
            void testNtExtendedBug() {
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c").setAtomName(4, "t").setAtomName(5,
                                                                                                                     "x")
                        .startRule(CHOICERULE).addHead(1).addHead(2).addHead(3).endRule() // {a,b,c}.
                        .startRule(CONSTRAINTRULE, 2).addHead(4).addToBody(2, true).addToBody(4, true).addToBody(5,
                                                                                                                 true).endRule()
            ...
            void testNtExtendedFalse() {
                ...
                builder.start(ctx, LogicProgram::AspOptions().noEq())
                        .setAtomName(1, "x").setAtomName(2, "y").setAtomName(3, "z").setAtomName(4, "r").setAtomName(5,
                                                                                                                     "s")
                        ...
                        .startRule(CONSTRAINTRULE, 2).addHead(4).addToBody(1, true).addToBody(2, true).addToBody(5,
                                                                                                                 true).endRule()
                        .startRule().addHead(5).addToBody(4, true).addToBody(3, true).endRule()
            ...
            void testDependentExtReason() {
                ...
                // y :- x, r.
                builder.start(ctx, LogicProgram::AspOptions().noEq())
                        .setAtomName(1, "x").setAtomName(2, "y").setAtomName(3, "z").setAtomName(4, "q").setAtomName(5,
                                                                                                                     "r")
                        .startRule(CHOICERULE).addHead(3).addHead(4).addHead(5).endRule()
                        .startRule().addHead(1).addToBody(4, false).endRule()
                        .startRule(CONSTRAINTRULE, 2).addHead(1).addToBody(1, true).addToBody(2, true).addToBody(3,
                                                                                                                 true).endRule()
            ...
            void testChoiceCardInterplay() {
                builder.start(ctx, LogicProgram::AspOptions().noEq())
                        ...
                        .startRule(CONSTRAINTRULE, 1).addHead(2).addToBody(1, true).addToBody(3,
            ...
            void testCardInterplayOnBT() {
                builder.start(ctx, LogicProgram::AspOptions().noEq())
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c").setAtomName(4, "d").setAtomName(5,
                                                                                                                     "z")
                        .startRule(CHOICERULE).addHead(1).addHead(
                                5).endRule()                                  // {a,z}.
                        .startRule(CONSTRAINTRULE, 1).addHead(2).addToBody(1, true).addToBody(3,
                                                                                              true).endRule() // b :- 1{a,c}
                        .startRule(BASICRULE).addHead(2).addToBody(4,
                                                                   true).endRule()                           // b :- d.
                        .startRule(BASICRULE).addHead(4).addToBody(2,
                                                                   true).endRule()                           // d :- b.
                        .startRule(BASICRULE).addHead(4).addToBody(5,
                                                                   true).endRule()                           // d :- z.
                        .startRule(BASICRULE).addHead(3).addToBody(2, true).addToBody(4,
                                                                                      true).endRule()          // c :- b,d.
                        .endProgram();
                CPPUNIT_ASSERT(builder.stats.sccs == 1);
                attachUfs();
            ...
            void testInitialStopConflict() {
                ...
                CPPUNIT_ASSERT(solver().isFalse(builder.getAtom(1)->literal()) &&
                               solver().isFalse(builder.getAtom(2)->literal()));
            }
