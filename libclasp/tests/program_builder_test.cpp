    ...
    namespace Test {
        ...
        public:
            ...
            void testDontAddDuplicateSumBodies() {
                ...
                // y :- 2 [a=1, b=2, not c=1].
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c").setAtomName(4, "x").setAtomName(5,
                                                                                                                     "y")
                        .startRule(CHOICERULE).addHead(1).addHead(2).addHead(3).endRule()
                        .startRule(WEIGHTRULE, 2).addHead(4).addToBody(1, true, 1).addToBody(2, true, 2).addToBody(3,
                                                                                                                   false,
                                                                                                                   1).endRule()
                        .startRule(WEIGHTRULE, 2).addHead(5).addToBody(1, true, 1).addToBody(2, true, 2).addToBody(3,
                                                                                                                   false,
                                                                                                                   1).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
            ...
            void testDontAddDuplicateSimpBodies() {
                ...
                builder.start(ctx)
                        ...
                        .startRule(WEIGHTRULE, 8).addHead(1).addToBody(3, true, 2).addToBody(2, true, 3).addToBody(4,
                                                                                                                   true,
                                                                                                                   4).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
                CPPUNIT_ASSERT(builder.stats.bodies == 2);
            ...
            void testDontAddUnsupportedExtNoEq() {
                ...
                builder.start(ctx, LogicProgram::AspOptions().noEq())
                        ...
                        .startRule(CONSTRAINTRULE, 2).addHead(2).addToBody(1, true).addToBody(3, true).addToBody(4,
                                                                                                                 false).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram() && ctx.endInit());
            ...
            void testBug() {
                builder.start(ctx)
                        ...
                        .startRule().addHead(4).addToBody(3,
                                                          false).endRule()                                // a:-not b.
                        ;
                CPPUNIT_ASSERT_EQUAL(false, builder.endProgram() && ctx.endInit());
            }
            ...
            void testSatBodyBug() {
                builder.start(ctx)
                        ...
                        .startRule(CONSTRAINTRULE).setBound(1).addHead(2).addToBody(1, true).addToBody(3,
                                                                                                       true).endRule() // b :- 1 {a, c}.
            ...
            void testAssertEqSelfblocker() {
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "x").setAtomName(3, "y").setAtomName(4, "q").setAtomName(5,
                                                                                                                     "r")
                        .startRule().addHead(1).addToBody(2, false).addToBody(3,
                                                                              false).endRule()    // a :- not x, not y.
                        .startRule().addHead(1).addToBody(4, false).addToBody(5,
                                                                              false).endRule()    // a :- not q, not r.
            ...
            void testAddClauses() {
                ...
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c")
                        .startRule().addHead(1).addToBody(2,
                                                          false).endRule()                                // a :- not b.
                        .startRule().addHead(1).addToBody(2, true).addToBody(3, true).endRule() // a :- b, c.
                        .startRule().addHead(2).addToBody(1,
                                                          false).endRule()                                // b :- not a.
                        .startRule().addHead(3).addToBody(2,
                                                          false).endRule()                                // c :- not b.
                        ;
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram() && ctx.endInit());
                CPPUNIT_ASSERT_EQUAL(3u, ctx.numVars());
                ...
                cl.push_back(~ctx.symbolTable()[2].lit);
                ...
                cl.clear();
                cl.push_back(negLit(bodyBC));
                cl.push_back(ctx.symbolTable()[3].lit);
                std::sort(cl.begin(), cl.end());
                CPPUNIT_ASSERT(std::find(o->clauses_.begin(), o->clauses_.end(), cl) != o->clauses_.end());
                cl.clear();
            ...
            void testAddCardConstraint() {
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c").setAtomName(4, "d")
                                // a :- 1 { not b, c, d }
                                // {b,c}.
                        .startRule(CONSTRAINTRULE).setBound(1).addHead(1).addToBody(2, false).addToBody(3,
                                                                                                        true).addToBody(
                                4, true).endRule()
            ...
            void testAddWeightConstraint() {
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c").setAtomName(4, "d")
                                // a :- 2 [not b=1, c=2, d=2 ]
                        .startRule(WEIGHTRULE).setBound(2).addHead(1).addToBody(2, false, 1).addToBody(3, true,
                                                                                                       2).addToBody(4,
                                                                                                                    true,
                                                                                                                    2).endRule()
                        .startRule(CHOICERULE).addHead(2).addHead(3).endRule();;
            ...
            void testEqOverBodiesOfDiffType() {
                builder.start(ctx)
                        ...
                        .startRule(CONSTRAINTRULE, 2).addHead(4).addToBody(1, true).addToBody(2, true).addToBody(3,
                                                                                                                 true).endRule()
            ...
            void testAllBodiesSameLit2() {
                ...
                // r :- s, y.
                builder.start(ctx)
                        .setAtomName(1, "z").setAtomName(2, "r").setAtomName(3, "q").setAtomName(4, "s").setAtomName(5,
                                                                                                                     "y")
            ...
            void testCompLit() {
                ...
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "x").setAtomName(4, "y").setAtomName(5,
                                                                                                                     "c")
            ...
            void testFunnySelfblockerOverEqByTwo() {
                ...
                builder.start(ctx)
                        ...
                        .setAtomName(5, "d").setAtomName(6, "c").setAtomName(7, "a").setAtomName(8, "r").setAtomName(9,
                                                                                                                     "s")
                        .startRule(CHOICERULE).addHead(1).addHead(2).addHead(3).endRule()
                        .startRule().addHead(4).addToBody(1, true).addToBody(2, true).endRule()
            ...
            void testRemoveKnownAtomFromWeightRule() {
                ...
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "q").setAtomName(4, "r").setAtomName(5,
                                                                                                                     "x")
                        .startRule(CHOICERULE).addHead(3).addHead(4).endRule()
                        .startRule().addHead(1).endRule()
                        .startRule(WEIGHTRULE).addHead(5).setBound(5).addToBody(1, true, 2).addToBody(2, false,
                                                                                                      2).addToBody(3,
                                                                                                                   true).addToBody(
                                4, true).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
            ...
            void testMergeEquivalentAtomsInConstraintRule() {
                ...
                builder.start(ctx)
                        ...
                        .startRule().addHead(1).addToBody(2, true).endRule()
                        .startRule().addHead(2).addToBody(1, true).endRule()
                        .startRule(CONSTRAINTRULE).addHead(4).setBound(2).addToBody(1, true).addToBody(2,
                                                                                                       true).addToBody(
                                3, true).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
                builder.write(str);
            ...
            void testMergeEquivalentAtomsInWeightRule() {
                ...
                builder.start(ctx)
                        ...
                        .startRule().addHead(1).addToBody(2, true).endRule()
                        .startRule().addHead(2).addToBody(1, true).endRule()
                        .startRule(WEIGHTRULE).addHead(4).setBound(3).addToBody(1, true, 1).addToBody(3, true,
                                                                                                      4).addToBody(2,
                                                                                                                   true,
                                                                                                                   2).addToBody(
                                5, true, 1).endRule();
            ...
            void testBothLitsInConstraintRule() {
                ...
                builder.start(ctx)
                        ...
                        .startRule().addHead(2).addToBody(1, true).endRule()
                        .startRule().addHead(3).addToBody(2, true).endRule()
                        .startRule(CONSTRAINTRULE).addHead(4).setBound(1).addToBody(1, true).addToBody(2,
                                                                                                       false).addToBody(
                                2, true, 2).addToBody(3, false).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
                builder.write(str);
                std::string x = str.str();
                // x :-  1 [a=2, not a=2].
            ...
            void testBothLitsInWeightRule() {
                ...
                builder.start(ctx)
                        ...
                        .startRule().addHead(2).addToBody(1, true).endRule()
                        .startRule().addHead(3).addToBody(2, true).endRule()
                        .startRule(WEIGHTRULE).addHead(4).setBound(3).addToBody(1, true, 3).addToBody(2, false,
                                                                                                      1).addToBody(3,
                                                                                                                   false,
                                                                                                                   3).addToBody(
                                5, true, 2).endRule();
            ...
            void testWeightlessAtomsInWeightRule() {
                ...
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c").setAtomName(4, "x")
                        .startRule(CHOICERULE).addHead(1).addHead(2).addHead(3).endRule()
                        .startRule(WEIGHTRULE).addHead(4).setBound(1).addToBody(1, true, 1).addToBody(2, true,
                                                                                                      1).addToBody(3,
                                                                                                                   true,
                                                                                                                   0).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
            ...
            void testSimplifyToNormal() {
                ...
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c")
                        .startRule(CHOICERULE).addHead(1).endRule()
                        .startRule(WEIGHTRULE).addHead(2).setBound(2).addToBody(1, true, 2).addToBody(3, false,
                                                                                                      1).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
                builder.write(str);
                std::string x = str.str();
            ...
            void testSimplifyToCardBug() {
                ...
                builder.start(ctx)
                        ...
                        .startRule(WEIGHTRULE).addHead(3).setBound(168).addToBody(1, false, 576).addToBody(2, false,
                                                                                                           381).endRule()
                        .setCompute(3, false);
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
            ...
            void testSimplifyCompBug() {
                ...
                builder.start(ctx, LogicProgram::AspOptions().iterations(1))
                        ...
                        .startRule().addHead(8).addToBody(4, true).addToBody(5, true).addToBody(2, true).addToBody(6,
                                                                                                                   true).addToBody(
                                7, true).endRule();
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram());
            ...
            void testBPWeight() {
                ...
                builder.start(ctx)
                        .setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c").setAtomName(4, "d").setAtomName(5,
                                                                                                                     "x")
                        .startRule(CHOICERULE).addHead(1).addHead(2).addHead(3).addHead(4).endRule()
                        .startRule(WEIGHTRULE).addHead(5).setBound(2).addToBody(1, true, 1).addToBody(2, true,
                                                                                                      2).addToBody(3,
                                                                                                                   false,
                                                                                                                   2).addToBody(
                                4, true, 1).endRule()
            ...
            void testExtLitsAreFrozen() {
                ...
                builder.start(ctx)
                        ...
                        .startRule(CHOICERULE).addHead(1).addHead(2).addHead(3).addHead(4).addHead(5).addHead(
                                6).addHead(7).endRule()
                        .startRule(CONSTRAINTRULE, 2).addHead(8).addToBody(2, true).addToBody(3, true).addToBody(4,
                                                                                                                 true).endRule()
                        .startRule(WEIGHTRULE, 2).addHead(9).addToBody(3, true, 1).addToBody(4, true, 2).addToBody(5,
                                                                                                                   true,
                                                                                                                   1).endRule()
            ...
            void testBackpropTrueCon() {
                Var r, s, x, y, a, t;
                builder.start(ctx, LogicProgram::AspOptions().backpropagate())
                        .setAtomName(r = 2, "r").setAtomName(s = 3, "s").setAtomName(x = 4, "x").setAtomName(a = 5,
                                                                                                             "a").setAtomName(
                                y = 6, "y").setAtomName(t = 7, "t")
                        ...
                        .startRule(CONSTRAINTRULE, 1).addHead(a).addToBody(r, false).addToBody(s,
                                                                                               false).endRule() // a :- 1 {not r, not s}.
                        .setCompute(1, false);
                CPPUNIT_ASSERT_EQUAL(true, builder.endProgram() && ctx.endInit());
            ...
            void testIncrementalEqResetState() {
                ...
                // d :- z, not r.
                builder.updateProgram();
                builder.setAtomName(3, "x").setAtomName(4, "y").setAtomName(5, "z").setAtomName(6, "c").setAtomName(7,
                                                                                                                    "d")
            ...
            void testIncrementalEqOverNeg() {
                ...
                // compute a(5),a(8).
                builder.updateProgram();
                builder.setAtomName(2, "a(2)").setAtomName(3, "a(3)").setAtomName(4, "a(4)").setAtomName(5,
                                                                                                         "a(5)").setAtomName(
                        6, "a(6)").setAtomName(7, "a(7)").setAtomName(8, "a(8)");
                ...
                builder.startRule().addHead(8).addToBody(6, false).addToBody(3,
                                                                             true).endRule();  // a(8) :- not a(6), a(3).
