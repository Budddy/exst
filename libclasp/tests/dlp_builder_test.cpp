    ...
    namespace Test {
        ...
        public:
            ...
            void testSubsumedChoice() {
                ...
                ctx.master()->undoUntil(0);
                CPPUNIT_ASSERT(index[4].lit == negLit(0) ||
                               !(ctx.master()->assume(index[4].lit) && ctx.master()->propagate()));
            }
            ...
            void testTautOverOne() {
                ...
                CPPUNIT_ASSERT(builder.stats.rules(DISJUNCTIVERULE).first == 1);
                const SymbolTable &index = ctx.symbolTable();
                CPPUNIT_ASSERT(index[1].lit == negLit(0) &&
                               !(ctx.master()->assume(index[1].lit) && ctx.master()->propagate()));
            }
            ...
            void testIncremental() {
                ...
                builder.setAtomName(4, "c").setAtomName(5, "d").setAtomName(6, "y")
                        .startRule(DISJUNCTIVERULE).addHead(4).addHead(5).addToBody(1, true).addToBody(6,
                                                                                                       true).endRule()
            ...
            void testSimplify() {
                ...
                builder.start(ctx);
                builder.updateProgram();
                builder.setAtomName(1, "a").setAtomName(2, "b").setAtomName(3, "c").setAtomName(4, "x").setAtomName(5,
                                                                                                                    "y")
