    ...
    namespace Test {
        ...
        public:
            ...
            void testMergeDuplicateInExtended() {
                ...
                rule.setType(CONSTRAINTRULE).setBound(2).addHead(1).addToBody(2, true).addToBody(3, false).addToBody(2,
                                                                                                                     true);
            ...
            void testNoContraExtended() {
                // a :- 2 {b, c, not b}.
                rule.setType(CONSTRAINTRULE).setBound(2).addHead(1).addToBody(2, true).addToBody(3, true).addToBody(2,
                                                                                                                    false);
                RuleType t = prg.simplifyRule(rule, head, body);
                ...
                // a :- 4 {not b, b, b, c, d}.
                rule.clear(), body.reset();
                rule.setType(CONSTRAINTRULE).setBound(4).addHead(1).addToBody(2, false).addToBody(2, true).addToBody(2,
                                                                                                                     true).addToBody(
                        3, true).addToBody(4, true);
                t = prg.simplifyRule(rule, head, body);
                CPPUNIT_ASSERT(t == WEIGHTRULE);
                ...
                rule.setType(WEIGHTRULE).setBound(4).addHead(1).addToBody(2, true, 2).addToBody(3, true).addToBody(2,
                                                                                                                   false).addToBody(
                        3, false, 2);
                t = prg.simplifyRule(rule, head, body);
                CPPUNIT_ASSERT(t == WEIGHTRULE);
            ...
            void testContraExtended() {
                // a :- 3 {b, c, not b, not c}.
                rule.setType(CONSTRAINTRULE).setBound(3).addHead(1).addToBody(2, true).addToBody(3, true).addToBody(2,
                                                                                                                    false).addToBody(
                        3, false);
                RuleType t = prg.simplifyRule(rule, head, body);
                CPPUNIT_ASSERT(t == ENDRULE);
            ...
            void testMultiSimplify() {
                ...
                //  - bound weights   : 1 [d=1]
                //  - flatten         : d.
                rule.setType(WEIGHTRULE).addHead(1).setBound(1).addToBody(2, true).addToBody(3, true).addToBody(4, true,
                                                                                                                2).addToBody(
                        5, true);
            ...
            void testCardinalityIfAllWeightsEqual() {
                // a :- 3 [b=2,c=2, d=2,e=0] ->
                rule.setType(WEIGHTRULE).addHead(1).setBound(3).addToBody(2, true, 2).addToBody(3, true, 2).addToBody(4,
                                                                                                                      true,
                                                                                                                      2).addToBody(
                        5, true);
                rule.body[3].second = 0;
                ...
                rule.setType(WEIGHTRULE).addHead(1).setBound(2).addToBody(2, true, 1).addToBody(3, true, 2).addToBody(2,
                                                                                                                      true,
                                                                                                                      1);
                t = prg.simplifyRule(rule, head, body);
                CPPUNIT_ASSERT(t == CONSTRAINTRULE);
            ...
            void testNormalIfMinWeightNeeded() {
                ...
                rule.setType(WEIGHTRULE).addHead(1).setBound(8).addToBody(2, true, 4).addToBody(3, true, 3).addToBody(4,
                                                                                                                      true,
                                                                                                                      2).addToBody(
                        5, true);
                rule.body[3].second = 0;
        ...
        public:
            ...
            void testSixThreeExp() {
                ...
                rule.setType(CONSTRAINTRULE);
                // a :- 3 {b, c, d, e, f, g}
                rule.addHead(1).addToBody(2, true).addToBody(3, true).addToBody(4, true).addToBody(5, true).addToBody(6,
                                                                                                                      true).addToBody(
                        7, true);
                rule.setBound(3);
                RuleTransform tm;
            ...
            void testWeightSixFourExp() {
                ...
                rule.addHead(1).addToBody(2, true, 4).addToBody(3, true, 3).addToBody(4, true, 2).addToBody(5, true,
                                                                                                            2).addToBody(
                        6, true, 1).addToBody(7, true, 1);
                rule.setBound(4);
                RuleTransform tm;
            ...
            void testStupidWeightBug() {
                ...
                prg.setExtendedRuleMode(LogicProgram::mode_transform_weight);
                prg.startRule(CHOICERULE).addHead(1).addHead(2).addHead(3).addHead(4).addHead(5).addHead(6).addHead(
                        7).addHead(8).endRule();
                rule.setType(WEIGHTRULE);
                // x :- 24 {a=31, b=29, c=29, d=28, e=21, f=15, g=8, h=5}
                rule.addHead(9).addToBody(1, true, 31).addToBody(2, true, 29).addToBody(3, true, 29).addToBody(4, true,
                                                                                                               28).addToBody(
                                5, true, 21).addToBody(6, true, 15)
