...
namespace Clasp {
    ParseError::ParseError(unsigned a_line, const char *a_msg) : ClaspError(
            clasp_format_error("Parse Error: Line %u, %s", a_line, a_msg)), line(a_line) { }
/////////////////////////////////////////////////////////////////////////////////////////
// StreamSource
/////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    bool LparseParser::parseRule(int rt) {
        if (knownRuleType(rt)) {
            ...
            if (rt == Asp::CHOICERULE || rt == Asp::DISJUNCTIVERULE) {
                ...
                weights = rt == Asp::WEIGHTRULE &&
                          check(input()->parseInt(bound, 0, INT_MAX), "Weightrule: Positive weight expected!");
            }
            ...
            check(rt != Asp::CONSTRAINTRULE || input()->parseInt(bound, 0, INT_MAX),
                  "Constraint rule: Positive bound expected!");
            ...
            if (rt == 91) {
                builder_->freeze(a, static_cast<ValueRep>((input()->parseInt(0, 2, "0..2 expected") ^ 3) - 1));
            }
    ...
    bool DefaultLparseParser::parseRuleExtension(int) {
        input()->error("Unsupported rule type!");
        return false;
    }
/////////////////////////////////////////////////////////////////////////////////////////
// DIMACS PARSING
