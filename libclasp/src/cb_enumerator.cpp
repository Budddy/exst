...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        void doCommitModel(Enumerator &ctx, Solver &s) {
            static_cast<CBConsequences &>(ctx).addCurrent(s, current, s.model);
        }
...
/////////////////////////////////////////////////////////////////////////////////////////
    CBConsequences::CBConsequences(Consequences_t type)
            : Enumerator(), shared_(0), type_(type) { }

    Enumerator *EnumOptions::createConsEnumerator(const EnumOptions &opts) {
        return new CBConsequences(opts.enumMode == enum_brave ? CBConsequences::brave_consequences
                                                              : CBConsequences::cautious_consequences);
    }
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    bool CBConsequences::CBFinder::doUpdate(Solver &s) {
        ...
        if (!shared) {
            ret = !current.empty() ? ClauseCreator::create(s, current, flags, ClauseInfo(Constraint_t::learnt_other))
